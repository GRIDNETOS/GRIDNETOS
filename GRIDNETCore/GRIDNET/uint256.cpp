...
{
 assertGN(vch.size() == sizeof(data));
	memcpy(data, &vch[0], sizeof(data));
}

template <unsigned int BITS>
void base_blob<BITS>::GetBytes(char * bytes) const
{
...
template void base_blob<160>::GetBytes(char *) const;
...
template void base_blob<256>::GetBytes(char *) const;
