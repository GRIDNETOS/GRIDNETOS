...
public:
	...
	//@{
		...
		int GetCoefficient(size_t i) const
			{return (i/WORD_BITS < mRegisters.size()) ? int(mRegisters[i/WORD_BITS] >> (i % WORD_BITS)) & 1 : 0;}
		//! return coefficient for x^i
	...
	//@{
		...
		//!
		void swap(PolynomialMod2 &a) {mRegisters.swap(a.mRegisters);}
	//@}
