...
public:
	...
	ModularArithmetic(const Integer &modulus = Integer::One())
		: AbstractRing<Integer>(), m_modulus(modulus), m_result((word)0, modulus.mRegisters.size()) {}

	//! \brief Copy construct a ModularArithmetic
	//! \param ma other ModularArithmetic
	ModularArithmetic(const ModularArithmetic &ma)
		: AbstractRing<Integer>(), m_modulus(ma.m_modulus), m_result((word)0, ma.m_modulus.mRegisters.size()) {}
	...
	void SetModulus(const Integer &newModulus)
		{m_modulus = newModulus; m_result.mRegisters.resize(m_modulus.mRegisters.size());}
...
public:
	...
	Integer ConvertIn(const Integer &a) const
		{return (a<<(WORD_BITS*m_modulus.mRegisters.size()))%m_modulus;}

	Integer ConvertOut(const Integer &a) const;

	const Integer& MultiplicativeIdentity() const
		{return m_result1 = Integer::Power2(WORD_BITS*m_modulus.mRegisters.size())%m_modulus;}
