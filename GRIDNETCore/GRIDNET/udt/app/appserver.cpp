...
void monitorActiveSessions() {
    while (true) {
        ...
        std::cout << "Active sessions: " << active_sessions.load() << std::endl;
    }
}

int main(int argc, char* argv[])
{
    std::thread monitorThread(monitorActiveSessions);
...
#endif
{
   ...
   while (true)
   {
      ...
      if (rsize < size)
      {
          cout << "Session ended or error occurred for client: " << endl;
          active_sessions--;
          break;
      }
   }
