...
// specifiers (calls assertGN() by default).
//
...
// Error handling; calls assertGN() by default.
...
#   define TINYFORMAT_ERROR(reason) assertGN(0 && reason)
#endif
...
#       endif
		...
		{
			static void invoke(std::ostream& /*out*/, const T& /*value*/) { assertGN(0); }
		};
		...
		struct convertToInt
		{
			static int invoke(const T& /*value*/)
			{
				TINYFORMAT_ERROR("tinyformat: Cannot convert from argument type to "
					"signedInteger for use as variable width or precision");
				return 0;
			}
		};
...
#       define TINYFORMAT_MAKE_FORMATLIST_CONSTRUCTOR(n)       \
        ...
        FormatListN(TINYFORMAT_VARARGS(n))                     \
            : FormatList(&m_formatterStore[0], n)              \
        { assertGN(n == N); init(0, TINYFORMAT_PASSARGS(n)); }   \
                                                               \
        template<TINYFORMAT_ARGTYPES(n)>                       \
